...
# Для локальной разработки/контейнера допускаем "insecure" значение по умолчанию,
# но для production обязательно задайте SECRET_KEY через переменные окружения.
